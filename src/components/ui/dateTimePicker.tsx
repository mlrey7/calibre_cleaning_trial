...
function DateField(props: AriaDatePickerProps<DateValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "inline-flex h-10 flex-1 items-center rounded-l-md border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex items-center rounded-md border ring-offset-background focus-within:ring-2 focus-within:ring-primary"
      )}
    >
